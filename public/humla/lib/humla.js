                        ...
                        if (mainConfig.data.extensions && suplConfig.data.extensions)                        
                            for (var x2 = 0; x2 < mainConfig.data.extensions.length; x2++) {
                                for (var y2 = 0; y2 < suplConfig.data.extensions.length; y2++) {
                                    if (mainConfig.data.extensions[x2] && mainConfig.data.extensions[x2].id == suplConfig.data.extensions[y2].id)
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4) {
                if (xhr.status == 200) {
                    var data = null;                    
                    try {
                        //remove all comments from json file
                        ...
                        callback(null, xhr.status, 
                            "Error when parsing JSON data. " + e);
                    }
