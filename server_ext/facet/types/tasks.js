...
/**
 * Parses information from microdata item of type Tasks. It is a boolean based type
...
exports.parse = function(mapping, course, lecture, data){ 
    ...
    processTasks(mapping, toProcess, course ,lecture);        
}
...
function processTasks(mapping, items , course, lecture){
    try{
        ...
        console.error("processTasks: "+_err.toString());
    }
}