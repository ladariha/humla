...
/**
 * Updates overall feed and all course feeds
 * @param domain domain (for links)
 */
...
/**
* Main function that handles feed generations.
* @param title feed's title
* @param subtitle feed's subtitle
* @param domain domain
* @param link link for the handled atom.xml file
* @param folder file system path to the atom.xml file
 */
function AtomModule(title, subtitle, domain, link, folder){
    ...
    /**
     * Call richDataGenerator over each lecture 
     */
    ...
    /**
     * Receives notifications and stores the received information. If number of received notifications
     * is equal to number of expected it writes the feed to the files
     */
    ...
    /**
     * Checks if  number of received notifications is equal to number of expected
     */
    ...
    /**
     * Creates atom entry for given lecture
     * @param lecture lecture object
     * @param list content generated by richDataGenerator
     */
